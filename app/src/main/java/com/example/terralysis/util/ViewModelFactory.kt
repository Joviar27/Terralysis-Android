...
class ViewModelFactory (
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(HistoryViewModel::class.java) -> HistoryViewModel(scanRepository) as T
            modelClass.isAssignableFrom(DetailViewModel::class.java) -> DetailViewModel(scanRepository) as T
